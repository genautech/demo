...
export default function SnapshotsPage() {
  ...
  const topUsers = [
    { name: "Ana Oliveira", level: "platinum", points: 15800, purchases: 35 },
    { name: "Maria Santos", level: "gold", points: 8200, purchases: 18 },
    { name: "Lucas Mendes", level: "gold", points: 6500, purchases: 15 },
    { name: "João Silva", level: "gold", points: 4500, purchases: 12 },
    { name: "Fernanda Lima", level: "silver", points: 3200, purchases: 8 },
  ]
  ...
  const achievements = [
    ...
    { icon: "💰", name: "Grande Gastador", description: "Gastou mais de 500 pontos", unlocked: true },
    { icon: "🏆", name: "Mestre dos Pontos", description: "Acumulou 5000 pontos", unlocked: true },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-8">
      <div className="mx-auto max-w-7xl space-y-8">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Visualização de nível, pontos e conquistas do usuário</CardDescription>
              </div>
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="rounded-lg bg-gradient-to-br from-primary/10 to-primary/5 p-4">
                      ...
                      <p className="mt-2 text-3xl font-bold">{mockUser.points.toLocaleString("pt-BR")}</p>
                    </div>
        ...
        {/* Snapshot 5: Points Economy Stats */}
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="rounded-xl border p-6 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-sm font-medium text-muted-foreground">Pontos Distribuídos</span>
                  </div>
                ...
                <div className="rounded-xl border p-6 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-sm font-medium text-muted-foreground">Pontos Utilizados</span>
                  </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Produtos elegíveis com preços em reais e pontos</CardDescription>
              </div>
              <div className="flex items-center gap-2">
                <Badge variant="outline" className="text-xs">
                    ...
                    <CardContent className="p-4 space-y-2">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-amber-600 flex items-center gap-1">
                          ...
                          {product.points.toLocaleString()} pontos
                        </p>
                      </div>
