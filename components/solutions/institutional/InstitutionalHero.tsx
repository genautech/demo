...
import { ArrowRight, Play, Sparkles, Zap, Puzzle, Rocket, Clock, DollarSign, TrendingUp } from "lucide-react"
  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute top-[30%] -left-[15%] w-[40%] h-[40%] bg-violet-500/10 blur-[120px] rounded-full" />
        ...
        <motion.div
          ...
          className="absolute top-[20%] left-[10%] w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 opacity-20 rotate-12"
        />
        <motion.div
          animate={{ y: [0, 10, 0] }}
          transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
          className="absolute top-[60%] right-[8%] w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-400 to-purple-500 opacity-15 -rotate-12"
        />
        <motion.div
          animate={{ y: [0, -8, 0] }}
          transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-[30%] left-[15%] w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-400 to-blue-500 opacity-20 rotate-6"
        />
      </div>
      ...
      <div className="container px-4 mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 mb-8 text-sm font-medium rounded-full bg-gradient-to-r from-primary/10 to-violet-500/10 text-primary border border-primary/20"
          >
            <Sparkles className="w-4 h-4" />
            <span>E-commerce + Gamificação + Fulfillment</span>
            <span className="text-muted-foreground">em uma API</span>
          </motion.div>
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-card border border-border/50 text-sm">
              ...
              <span className="text-muted-foreground">Integre via</span>
              <span className="font-semibold">API REST</span>
            </div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-card border border-border/50 text-sm">
              <Rocket className="w-4 h-4 text-violet-500" />
              <span className="text-muted-foreground">ou use</span>
              <span className="font-semibold">nativamente</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col items-center p-4 rounded-xl bg-card/50 border border-border/50">
              ...
              <span className="text-xs text-muted-foreground">menos erros</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/20">
              <span className="text-lg">🎯</span>
              <span className="text-foreground font-medium">SLA até 99.99%</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/20">
              <span className="text-lg">🏆</span>
              <span className="text-foreground font-medium">Google for Startups Alumni</span>
            </div>
          </motion.div>
        </div>
      </div>
